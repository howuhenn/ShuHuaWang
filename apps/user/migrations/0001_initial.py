...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Area',
            fields=[
                ('area_code', models.CharField(max_length=6, primary_key=True, serialize=False, verbose_name='区域code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Area', verbose_name='区域code')),
